...
class VentanaClientes(QtWidgets.QMainWindow):
    ...
    def consultar(self):
        ...
        if aCli.tamañoArregloCliente() == 0:
            QtWidgets.QMessageBox.information(self, "Consultar Cliente", "No existen clientes a  
                                                  consultar...!!!", QtWidgets.QMessageBox.Ok)
        else:
            dni, _ = QtWidgets.QInputDialog.getText(self, "Consultar Cliente", "Ingrese
                                                      el DNI a consultar")
    ...
    def modificar(self):
        if aCli.tamañoArregloCliente() == 0:
            ...
            dni, _ = QtWidgets.QInputDialog.getText(self, "Modificar Cliente", "Ingrese el DNI a
                                                        modificar")
            pos = aCli.buscarCliente(dni)
            if pos != -1:
